Protected area irreplaceability in the European Wildfire Risk Assessment

Ecological Irreplaceability score of the protected areas (IUCN Red List of Threatened Species: amphibians, mammals, birds – World Database on Protected Areas).  Data derived after https://doi.org/10.1126/science.1239268 https://irreplaceability.cefe.cnrs.fr/about https://www.protectedplanet.net [preliminary prototype approximation].
...
In each spatial cell c, the variable is expressed as percentile (%), i.e. as percentage of the other cells whose value is less than in c.

Layer name : Protected area irreplaceability
Layer group: Basic layers
Layer unit : Percentile (%)
CSV file   : var-Irr_unit-dimensionless.csv
